...
public class TestRunRequest {
    ...
    @JsonIgnore
    @AssertTrue(message = "Exactly one of testSuiteId, testCases, or testInputs is required")
    public boolean isTestSourceValid() {
        int sourceCount = testSuiteId == null ? 0 : 1;
        sourceCount += testCases == null || testCases.isEmpty() ? 0 : 1;
